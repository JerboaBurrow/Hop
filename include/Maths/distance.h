...
namespace Hop::Maths
{
    ...
    )
    {
        ...
        s11 = axisOverlap(r1,r2,r1->axis1x,r1->axis1y);
        ...
        s12 = axisOverlap(r1,r2,r1->axis2x,r1->axis2y);
        ...
        s21 = axisOverlap(r1,r2,r2->axis1x,r2->axis1y);
        ...
        s22 = axisOverlap(r1,r2,r2->axis2x,r2->axis2y);

...
int main(int argc, char ** argv)
{
    ...
    jGL::DesktopDisplay display(glm::ivec2(resX,resY),"Sprites", conf);
    ...
    Hop::World::FiniteBoundary<double> mapBounds(0,0,16,16, true, true, true, true);
